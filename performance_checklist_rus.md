...
<p>
    Текущие микро-оптимизации — это отличный способ,
...
<p>
    ...
    Перед тем как приступить, пройдите бесплатный <a href="https://www.udacity.com/course/browser-rendering-optimization--ud860" target="_blank">курс на Udacity – оптимизация рендера браузером</a>.
...
<p>
    ...
    Вы можете уйти от использования <a href="https://daniel.haxx.se/blog/2016/08/18/http2-connection-coalescing/" target="_blank"> HTTP/2 объединяющим соединением</a>, что позволяет Вам использовать
...
">представили миру Brotli</a>, новый формат данных без потерь,
    ...
    с улучшенным кодированием Deflate, потому что файлы будут на 3-8% меньше, чем может
    предоставить лучшее сжатие от Zlib’s. Загвоздка в том, что это займет гораздо больше
...
<ol>
    ...
    <li>Подготовьте критичный CSS для основы интерфейса и включите его в <code>
